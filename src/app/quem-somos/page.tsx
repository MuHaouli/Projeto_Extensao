          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-[#304878] mb-12">
                Conheça a equipe por trás do Interrogatio e nossa missão de
                transformar o processo de entrevistas profissionais através da
                tecnologia.
              </p>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  <div className="w-24 h-24 bg-[#000000] rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                    <Image
                      src="/images/Brunao.jpg"
                      alt="Bruno De Souza Araujo"
                      width={96}
                      height={96}
                  ...
                  <a
                    href="https://github.com/brunoSouza0103"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#F0A818] hover:text-[#000000] transition-colors text-sm font-medium"
                  >
                ...
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  ...
                  <a
                    href="https://github.com/joaomarin789"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#F0A818] hover:text-[#000000] transition-colors text-sm font-medium"
                  >
                ...
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  <div className="w-24 h-24 bg-[#F0A818] rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                    <Image
                      src="/images/Dutra.jpg"
                      alt="Leonardo Dutra Da Cruz"
                      width={96}
                      height={96}
                      className="w-full h-full object-cover"
                    />
                  ...
                  <p className="text-[#304878] mb-3">Engenharia De Software</p>
                  <a
                    href="https://github.com/leodutrax"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#F0A818] hover:text-[#000000] transition-colors text-sm font-medium"
                  >
                ...
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  ...
                  <p className="text-[#304878] mb-3">Engenharia De Software</p>
                  <a
                    href="https://github.com/LuizHillebrande"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#F0A818] hover:text-[#000000] transition-colors text-sm font-medium"
                  >
                ...
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  ...
                  <p className="text-[#304878] mb-3">Ciência Da Computação</p>
                  <a
                    href="https://github.com/MuHaouli"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#F0A818] hover:text-[#000000] transition-colors text-sm font-medium"
                  >
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-700">
                    Acreditamos no poder do trabalho em equipe e na diversidade de
                    perspectivas para criar soluções melhores.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-700">
                    Comprometidos com a qualidade e a excelência em tudo que
                    fazemos, desde o código até a experiência do usuário.
                  </p>
                </div>
              </div>
            </div>
