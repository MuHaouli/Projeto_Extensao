...
export default function Home() {
  ...
  const handleExplorarClick = (event: React.MouseEvent<HTMLButtonElement>) => {
    // Rola suavemente até a seção do carrossel
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section className="bg-gradient-to-b from-[#7890A8] to-white fade-in-up">
          <div className="container-custom py-20 flex flex-col lg:flex-row items-center gap-10">
            <div className="max-w-2xl text-center lg:text-left fade-in-up">
              ...
              <button onClick={handleExplorarClick} className="btn-primary inline-block">
                Explorar
              </button>
            </div>
        ...
        {/* Carrossel */}
        <section id="carousel" className="py-20 bg-[#F4F4F4] fade-in-up">
          <div className="container-custom max-w-4xl mx-auto text-center">
            ...
            <div className="relative">
              <img 
                ...
                alt="Carrossel" 
                className="w-full max-w-3xl mx-auto h-64 md:h-80 rounded-xl shadow-lg transition-all duration-500 object-contain"
              />
              <button 
                onClick={prevSlide} 
      ...
      {/* Footer */}
      <footer className="bg-[#1B263B] text-white py-10 fade-in-up">
        <div className="container-custom text-center flex flex-col lg:flex-row items-center justify-center gap-4">
          <img src="/unifil-logo.png" alt="Logo UniFil" className="h-12 w-12 rounded-full border-2 border-white object-cover"/>
